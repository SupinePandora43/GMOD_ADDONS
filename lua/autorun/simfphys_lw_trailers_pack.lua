...
list.Set("simfphys_vehicles","trailer_transporter_lw",{
...
list.Set( "simfphys_vehicles","trailer_schmied_lw",{
...
list.Set("simfphys_vehicles","trailer_panel_lw",{
	Name = "Panel Trailer",
...
list.Set("simfphys_vehicles","trailer_truck_lw",{
...
list.Set("simfphys_vehicles","trailer_profiliner_lw",{
...
list.Set("simfphys_vehicles","trailer_glass_lw",{
	Name = "Glass Trailer",
...
list.Set("simfphys_vehicles","trailer_livestock_lw",{
...
list.Set("simfphys_vehicles","trailer_medbox_lw",{
